...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/bin/bazel',
    '/private/var/tmp/_bazel_bachvq/2b4e625c67b47b8a4930b2d8a0137888/execroot/__main__',
    'ios_x86_64',
    {
        'ios_arm64': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/bachvq/Library/Application Support/Tulsi/0.20210318.88/Bazel',
